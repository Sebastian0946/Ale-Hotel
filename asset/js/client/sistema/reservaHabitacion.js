...
async function loadTable() {
    try {
        ...
        if (response.ok) {
            ...
            items.data.forEach((reservaHabitacion) => {
                ...
                table.row.add([
                    ...
                    reservaHabitacion.HabitacionId.TipoHabitacionesId.Descripcion,
                    reservaHabitacion.HabitacionId.Descripcion,
                    reservaHabitacion.EstadoFacturaId.Descripcion,
                    `<div style="width: 200px;">${reservaHabitacion.FechaEntrada} | ${reservaHabitacion.FechaSalida}</div>`,
